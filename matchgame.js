...
// selected holds AT MOST 2 cards. It's used to check if the selected cards match.
...
function shuffleCards() {
    ...
    deck.forEach(card => {
        ...
        card.style.backgroundImage = 'url(smback.png';
...
function matchingCards(e) {
    ...
    if (selected.length === 2) {
        ...
        //If they're not the same
            ...
            setTimeout(() => {
                selected[0].style.backgroundImage = 'url(smback.png';
                selected[1].style.backgroundImage = 'url(smback.png'; 
            }, 1000);
        }
